  ...
  return (
    <div className='inline-flex items-center'>
        ...
        <div className={`flex ml-4 space-x-4 ${navState ? 'hidden' : ''}`}>
            <button onClick={props.toggleDarkMode} className='text-3xl dark:hover:text-[#37cdbe] hover:text-[#031b28] lg:hover:animate-pulse duration-75'>{props.darkMode ? <BsSun /> : <BsMoon />}</button>
            <button className="border-2 dark:border-[#37cdbe] dark:hover:bg-[#37cdbe] dark:hover:text-gray-800 border-[#031b28] hover:bg-[#031b28] hover:text-gray-300 font-bold py-2 px-4 rounded-lg inline-flex items-center lg:hover:animate-bounce ease-in-out duration-75">
