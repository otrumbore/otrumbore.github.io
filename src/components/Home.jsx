  ...
  return (
    <div name="home" className='w-full min-h-screen mt-[180px] landscape:mt-[100px] lg:landscape:mt-0 lg:h-screen lg:mt-0'>
      ...
      <div className='max-w-[1100px] mx-auto px-8 flex flex-col lg:flex-row lg:space-x-20 items-center justify-center h-full'>
        ...
        <h1 className='text-4xl md:text-5xl lg:text-6xl  font-bold text-[#031b28] dark:text-[#ccd6f6]'>Odnel Trumbore</h1>
        <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold dark:text-[#8892b0]'>I'm a Frontend Devloper</h2>
        ...
        <div className='py-4'>
          <button className="group border-2 dark:border-[#37cdbe] dark:hover:bg-[#37cdbe] border-[#031b28] hover:bg-[#031b28] hover:text-gray-300 ease-in-out duration-75 dark:hover:text-gray-800 font-bold py-3 px-6 rounded-lg flex items-center">View Work
